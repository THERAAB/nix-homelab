...
in {
  ...
  services.nfs.server = {
    ...
    exports = ''
      ...
      ${media-dir}  ${network.nix-server.local.ip}(rw,nohide,insecure,no_subtree_check,no_root_squash) ${network.nix-server.tailscale.ip}(rw,nohide,insecure,no_subtree_check,no_root_squash)
