...
in {
  ...
  services.nfs.server = {
    ...
    exports = ''
      ...
      ${backups-dir}  ${network.nix-hypervisor.local.ip}(rw,nohide,insecure,no_subtree_check,no_root_sqaush) ${network.nix-hypervisor.tailscale.ip}(rw,nohide,insecure,no_subtree_check,no_root_squash)
    '';
  };
}
