  ...
  config = mkIf cfg.enable {
    ...
    virtualisation.oci-containers.containers."${app-name}" = {
      ...
      environment = {
        ...
        TZ = "America/New_York";
        VPN_ENABLED = "true";
        VPN_LAN_NETWORK = "${properties.network.nix-desktop.local.ip},${properties.network.ap.subnet},${properties.network.micro-media.local.ip},${properties.network.micro-tailscale.local.ip},${properties.network.nix-hypervisor.local.ip}";
        VPN_CONF = "wg0";
